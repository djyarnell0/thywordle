...
export default function GameStatisticsCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
    ...
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await DataStore.save(new GameStatistics(modelFields));
          if (onSuccess) {
      ...
      {...getOverrideProps(overrides, "GameStatisticsCreateForm")}
      {...rest}
    >
      <TextField
