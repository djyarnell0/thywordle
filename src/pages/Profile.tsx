...
var averageGuessPerGame: number
;(stats: GameStats) => {
  averageGuessPerGame =
    1 * stats.winDistribution[0] +
    1 * stats.winDistribution[1] +
    1 * stats.winDistribution[2] +
    1 * stats.winDistribution[3] +
    1 * stats.winDistribution[4] +
    1 * stats.winDistribution[5]
}
